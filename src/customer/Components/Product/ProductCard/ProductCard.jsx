   ...
   <div onClick={handleNavigate} className='productCard w-[15rem] border m-3 transition-all cursor-pointer '>
    ...
    <div className='textPart bg-white p-3 '>
        ...
        <div className='flex space-x-2 items-center'>
            <p className='font-semibold'>{discountedPrice} đ</p>
            <p className='opacity-50 line-through'>{price} đ</p>
            <p className='text-green-600 font-semibold'>Giảm {discountPersent}% </p>
        </div>
