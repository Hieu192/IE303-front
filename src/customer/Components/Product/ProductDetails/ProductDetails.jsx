...
export default function ProductDetails() {
  ...
  console.log("test productcus", customersProduct)
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 items-center text-lg lg:text-xl tracking-tight text-gray-900 mt-6">
                <p className="font-semibold">
                  {customersProduct.product?.discountedPrice} đ
                </p>
                <p className="opacity-50 line-through">
                  {customersProduct.product?.price} đ
                </p>
                <p className="text-green-600 font-semibold">
                  Giảm {customersProduct.product?.discountPersent}% 
                </p>
              </div>

              {/* Reviews */}
              <div className="mt-6">
                <h3 className="sr-only">Các đánh giá</h3>
        ...
        <section className="">
          ...
          <div className="border p-5">
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                <h1 className="text-xl font-semibold pb-1">Xếp hạng sản phẩm</h1>
